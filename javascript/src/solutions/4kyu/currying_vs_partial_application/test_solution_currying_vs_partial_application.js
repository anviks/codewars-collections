...
import { curryPartial } from './solution_currying_vs_partial_application.js';

const Test = { describe, it, assertEquals: assert.equal, assertDeepEquals: assert.deepEqual };
