...
class FixedTests(unittest.TestCase):
    def test_basic_test_cases(self):
        ...
        self.assertEqual(count_and_print_graph(text2, max2), solution2)

        text3 = "Let's suppose you have to use an old terminal window"
        max3 = 24
        solution3 = "e:########################\no:########################\ns:###################\na:##############\nl:##############\nn:##############\nt:##############\nu:##############\nd:#########\ni:#########\np:#########\nw:#########\nh:####\nm:####\nr:####\nv:####\ny:####"

        self.assertEqual(count_and_print_graph(text3, max3), solution3)
        ...
        self.assertEqual(count_and_print_graph(text4, max4), solution4)

        text5 = "abcda bcdbbd aooooo@ )(%& $%8 7235 4892"
        max5 = 10
        solution5 = "o:##########\nb:########\na:######\nd:######\nc:####"

        self.assertEqual(count_and_print_graph(text5, max5), solution5)

        text6 = "just a short text"
        max6 = 4
        solution6 = "t:####\ns:##\na:#\ne:#\nh:#\nj:#\no:#\nr:#\nu:#\nx:#"

        self.assertEqual(count_and_print_graph(text6, max6), solution6)
