/**
# [Program a Calculator #2 - 3D Vectors](https://www.codewars.com/kata/58ee4962dc4f81d6f400001c/solutions/rust)

## About

This Kata Series is aimed at representing mathematical concepts using code
and writing programs to solve simple, typical mathematical problems.
The solutions to these Kata may or may not be helpful in programming your own maths-based application.
*/
