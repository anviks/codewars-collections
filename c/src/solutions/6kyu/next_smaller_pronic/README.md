# [Next smaller pronic](https://www.codewars.com/kata/5a90f6d457c5624ecc000012)

This challenge is to efficiently find the largest [pronic number](https://en.wikipedia.org/wiki/Pronic_number) less than the method's input.
